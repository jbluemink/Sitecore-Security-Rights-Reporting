...
{
    public static class Rights90
    {
        public static List<string[]> Core900Replace = new List<string[]>
        {
...
,new[] { "/sitecore/client/Applications/ECM/Component/Navigation/Primary Navigation/PageSettings/Navigation Links/Dashboard/Administrator", @""}
,new[] { "/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Marketing/ECM", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/EXM", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/EXM/Buttons/Ribbon", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/EXM/EXM/Layout", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/EXM/EXM/New/Rendering", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/Page Editor/View Options For Limited Roles/Capabilities", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/Page Editor/View Options For Limited Roles/Show", @""}
,new[] { "/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/View/Capabilities", @""}
,new[] { "/sitecore/content/Documents and settings/All users/Start menu/Programs/Email Campaign", @""}
,new[] { "/sitecore/content/Documents and settings/All users/Start menu/Programs/Email Campaign/Settings", @""}
,new[] { "/sitecore/system/Settings/Html Editor Profiles/Message Content/Buttons", @""}
,new[] { "/sitecore/system/Settings/Html Editor Profiles/Message Content/Buttons/HTML View", @""}
,new[] { "/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Bold", @""}
,new[] { "/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Insert Image", @""}
...
,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Tools/UpdateCenter",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|"}
        ...
        public static List<string[]> Core910Replace = new List<string[]>
        {
            new[] {"/sitecore/client/Applications/UpdateCenter",@"ar|Everyone|pe|!*|pd|!*|ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|"}
            ,new[] {"/sitecore/client/Applications/FormsBuilder",@"ar|sitecore\Everyone|pe|!*|pd|!*|ar|sitecore\Forms Editor|pe|+item:read|pd|+item:read|"}
            ,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Tools/UpdateCenter",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|"}
        ...
        public static List<string[]> Core100Replace = new List<string[]>
        {
            new[] {"/sitecore/client/Applications/UpdateCenter",@"ar|Everyone|pe|!*|pd|!*|ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|"}
            ,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Tools/UpdateCenter",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|"}
            ,new[] {"/sitecore/content/Applications/Content Editor/Menues/Tag Content",@"ar|sitecore\Author|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
            ...
            ,new[] {"/sitecore/client/Applications/FormsBuilder/Pages/Forms/PageSettings/ActionControl/ActionColumn/Forms/ToggleSelection",@"ar|sitecore\Forms Data Administrator|pe|!*|ar|sitecore\Forms Editor|pe|+item:read|ar|sitecore\Forms Publisher|pe|+item:read|"}
            ,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/Optimization/Lists", @""}
            ,new[] {"/sitecore/client/Applications/ECM/AccessFolder/AdministratorArea",@"ar|sitecore\EXM Advanced Users|pe|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|pd|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|ar|sitecore\EXM Users|pe|-item:rename|-item:delete|-item:create|-item:admin|-item:write|-item:read|!*|pd|-item:rename|-item:delete|-item:create|-item:admin|-item:write|-item:read|!*|"}
            ,new[] {"/sitecore/client/Applications/ECM/AccessFolder/CampaignCreation",@"ar|sitecore\EXM Advanced Users|pe|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|pd|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|ar|sitecore\EXM Users|pe|-item:rename|-item:delete|-item:create|-item:admin|-item:write|-item:read|!*|pd|-item:rename|-item:delete|-item:create|-item:admin|-item:write|-item:read|!*|"}
            ,new[] {"/sitecore/client/Applications/ECM/AccessFolder/Delivery",@"ar|sitecore\EXM Advanced Users|pe|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|pd|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|ar|sitecore\EXM Users|pe|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|pd|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|+item:admin|"}
            ,new[] {"/sitecore/content/Applications/Content Editor/Menues/Editing/HttpEdit", @""}
            ,new[] {"/sitecore/content/Applications/Control Panel/Database/Database Usage", @""}
            ,new[] {"/sitecore/content/Applications/Control Panel/Indexing/Generate SOLR Schema", @""}
            ,new[] {"/sitecore/content/Documents and settings/All users/Start menu/Programs/Image Editor", @""}
            ,new[] {"/sitecore/content/Documents and settings/All users/Start menu/Programs/Search", @""}
            ,new[] { "/sitecore/content/Documents and settings/All users/Start menu/Right/Search", @""}
        };

        public static List<string[]> Core1001Replace = new List<string[]>
        {
            new[] {"/sitecore/client/Applications/UpdateCenter",@"ar|Everyone|pe|!*|pd|!*|ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|"}
            ,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Tools/UpdateCenter",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|"}
            ,new[] {"/sitecore/content/Applications/Content Editor/Menues/Tag Content",@"ar|sitecore\Author|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
            ...
            ,new[] {"/sitecore/content/Documents and settings/All users/Start menu/Programs/Search", @""}
            ,new[] { "/sitecore/content/Documents and settings/All users/Start menu/Right/Search", @""}
            ,new[] {"/sitecore/client/Applications/ECM/Component/Navigation/Primary Navigation/PageSettings/Navigation Links/Dashboard/Administrator",@"ar|sitecore\EXM users|pe|-item:rename|-item:delete|-item:create|-item:admin|-item:write|-bucket:makebucket|-bucket:unmake|-item:read|"}
        };
        public static List<string[]> Master900Replace = new List<string[]>
        {
new[] { "/sitecore/layout/Layouts/System/Email", @""}
,new[] { "/sitecore/media library/System/Email/Attachments", @""}
,new[] { "/sitecore/system/Marketing Control Panel/Test Lab/Emails", @""}
,new[] { "/sitecore/system/Settings/Email", @""}
,new[] { "/sitecore/system/Settings/Email/Tasks", @""}
,new[] { "/sitecore/templates/Branches/System/Email/Manager Root", @""}
,new[] { "/sitecore/templates/Branches/System/Email/Manager Root/$name", @""}
,new[] { "/sitecore/templates/Branches/System/Email/Manager Root/$name/Message Types", @""}
,new[] { "/sitecore/templates/Branches/System/Email/Manager Root/$name/Messages", @""}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/Buttons",@"ar|sitecore\Sitecore Client Users|pe|+item:read|pd|+item:read|"}
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/Page Editor/View Options For Limited Roles/Capabilities",@"ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|ar|sitecore\Sitecore Limited Page Editor|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Sprites/Experience Editor Speak Ribbon",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Designing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Maintaining|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/EXM/EXM/New/Rendering",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Designing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Maintaining|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/View/Capabilities",@"ar|sitecore\Sitecore Limited Page Editor|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Marketing/MarketingAutomation",@"ar|sitecore\Analytics Maintaining|pe|+item:read|pd|+item:read|ar|sitecore\Analytics Reporting|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/EXM/Buttons/Ribbon",@"ar|sitecore\Sitecore Minimal Page Editor|pe|-item:read|pd|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Insert Image",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Underline",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Default/WebEdit Buttons/Insert External Link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Full/WebEdit Buttons/Remove link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/content/Documents and settings/All users/Start menu/Programs/Email Campaign/Settings",@"ar|sitecore\EXM users|pe|-item:read|!*|pd|-item:read|!*|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Full/WebEdit Buttons/Insert External Link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Medium/WebEdit Buttons/Insert External Link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Bold",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/content/Documents and settings/All users/Start menu/Programs/Email Campaign",@"ar|sitecore\EXM Advanced Users|pe|+item:read|^*|pd|+item:read|^*|ar|sitecore\EXM Users|pe|+item:read|^*|pd|+item:read|^*|"}
...
,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Marketing/ECM",@"ar|sitecore\EXM Advanced users|pe|+item:read|pd|+item:read|ar|sitecore\EXM users|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Default/WebEdit Buttons/Remove link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/content/Applications/Control Panel/Indexing/Populate Solr Managed Schema",@"ar|sitecore\Sitecore Client Maintaining|pe|+item:read|pd|+item:read|a?|Everyone|p*|!*|"}
...
,new[] {"/sitecore/client/Applications/Launchpad/PageSettings/Buttons/Marketing/Forms",@"ar|sitecore\Forms Editor|pe|+item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/WebEdit/Page Editor/View Options For Limited Roles/Show",@"ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|ar|sitecore\Sitecore Limited Page Editor|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/EXM",@"ar|sitecore\Sitecore Minimal Page Editor|pe|-item:read|pd|-item:read|ar|sitecore\Sitecore Client Users|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Insert Link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Ribbons/EXM/EXM/Layout",@"ar|sitecore\Sitecore Client Developing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Designing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Maintaining|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
...
,new[] {"/sitecore/system/Settings/Security/Policies/Experience Explorer/Can Explore",@"ar|sitecore\Sitecore Client Designing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Authoring|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/Buttons/HTML View",@"ar|sitecore\Sitecore Client Users|pe|+item:read|pd|+item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Rich Text Medium/WebEdit Buttons/Remove link",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/system/Settings/Html Editor Profiles/Message Content/WebEdit Buttons/Italic",@"ar|sitecore\Sitecore Minimal Page Editor|pd|-item:read|pe|-item:read|"}
...
,new[] {"/sitecore/content/Applications/WebEdit/Menus/Other Views/Explore",@"ar|sitecore\Sitecore Client Designing|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Authoring|pe|+item:read|pd|+item:read|ar|sitecore\Sitecore Client Users|pe|!*|pd|!*|"}
...
,new[] {"/sitecore/content/Applications/Security",@"ar|Everyone|pd|!*|"} };
        ...
        {
new[] {"/sitecore/templates/System/Validation/Field Type Validation Rules/Validation Rules/Workflow",@"ar|sitecore\Sitecore Client Developing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/templates/Branches/System/Email/Manager Root/$name/Message Types",@"ar|sitecore\EXM Users|pd|+item:delete|+item:admin|+item:create|+item:rename|^*|+item:read|+item:write|pe|+item:delete|+item:admin|+item:create|+item:rename|^*|+item:read|+item:write|"}
,new[] {"/sitecore/templates/System/Validation/Global Validation Rules/Validation Rules/Validate Button",@"ar|sitecore\Sitecore Client Developing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Lifetime/Lifetime/__Hide version",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Maintaining|pe|+field:read|pd|+field:read|"}
...
,new[] {"/sitecore/templates/Branches/System/Email/Manager Root/$name/Messages",@"ar|sitecore\EXM Users|pd|^*|+item:admin|+item:create|+item:rename|+item:read|+item:write|pe|^*|+item:admin|+item:create|+item:rename|+item:read|+item:write|"}
...
,new[] {"/sitecore/templates/System/Templates/Sections/Workflow/Workflow/__Default workflow",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Maintaining|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Appearance/Appearance/__Icon",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/templates/Branches/System/Email/Manager Root/$name",@"ar|sitecore\EXM Users|pd|^*|+item:read|pe|^*|+item:read|ar|sitecore\EXM Advanced Users|pd|+item:delete|+item:admin|+item:create|+item:rename|^*|+item:read|+item:write|pe|+item:delete|+item:admin|+item:create|+item:rename|^*|+item:read|+item:write|"}
,new[] {"/sitecore/layout",@"au|sitecore\ServicesAPI|p*|-item:read|"}
,new[] {"/sitecore/system/Settings/Email",@"ar|sitecore\EXM Advanced Users|pd|+item:read|+item:write|pe|+item:read|+item:write|"}
...
,new[] {"/sitecore/system/List Manager/ListOperations",@"ar|sitecore\Analytics Maintaining|pe|+item:read|+item:create|pd|+item:rename|+item:create|+item:write|+item:read|+item:delete|"}
...
,new[] {"/sitecore/templates/System/Email/Messages/Inner Content/Message Root/__Standard Values",@"ar|sitecore\EXM users|pd|+item:delete|^*|pe|+item:delete|^*|"}
,new[] {"/sitecore/system/Settings/Buckets/Settings/Search Operations/Information Architecture/Delete All Items in List",@"ar|sitecore\Author|pe|-item:read|pd|-item:read|"}
...
,new[] {"/sitecore/templates/System/Validation/Field Type Validation Rules/Validation Rules/Quick Action Bar",@"ar|sitecore\Sitecore Client Developing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/templates/Branches/System/Email/Manager Root",@"ar|sitecore\EXM Users|pd|+item:read|pe|+item:read|ar|sitecore\EXM Advanced Users|pd|+item:read|pe|+item:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Help/Help/__Long description",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
...
,new[] {"/sitecore/templates/System/Validation/Field Type Validation Rules/Validation Rules/Validator Bar",@"ar|sitecore\Sitecore Client Developing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/system/Settings/Email/Tasks",@"ar|sitecore\EXM users|pd|+item:delete|+item:create|^*|+item:read|+item:write|pe|+item:delete|+item:create|^*|+item:read|+item:write|ar|sitecore\EXM Advanced users|pd|+item:delete|^*|+item:create|+item:read|+item:write|pe|+item:delete|^*|+item:create|+item:read|+item:write|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Security/Security/__Security",@"ar|sitecore\Sitecore Client Securing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/system/Settings/Buckets/Search Types/Debug",@"ar|sitecore\Author|pe|-item:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Appearance/Appearance/__Sortorder",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/templates/System/Item Buckets/Saved Search/__Standard Values",@"ar|sitecore\Everyone|pe|-item:read|au|$currentuser|pe|+item:read|"}
...
,new[] {"/sitecore/templates/System/Templates/Sections/Appearance/Appearance/__Editor",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/system/Settings/Buckets/Settings/Search Operations/Marketing/Apply Profile Score to All Items",@"ar|sitecore\Author|pe|+item:read|pd|+item:read|"}
,new[] {"/sitecore/media library/System/Email/Attachments",@"ar|sitecore\EXM users|pd|+item:delete|^*|+item:create|+item:read|+item:write|pe|+item:delete|^*|+item:create|+item:read|+item:write|ar|sitecore\EXM Advanced users|pd|+item:delete|+item:create|^*|+item:read|+item:write|pe|+item:delete|+item:create|^*|+item:read|+item:write|"}
,new[] {"/sitecore/system/Marketing Control Panel/Test Lab/Emails",@"ar|sitecore\EXM users|pd|+item:delete|^*|+item:create|+item:read|+item:write|pe|+item:delete|^*|+item:create|+item:read|+item:write|ar|sitecore\EXM Advanced users|pd|+item:delete|+item:create|^*|+item:read|+item:write|pe|+item:delete|+item:create|^*|+item:read|+item:write|"}
...
,new[] {"/sitecore/templates/System/Templates/Sections/Layout/Layout/__Renderings",@"ar|sitecore\Sitecore Client Developing|pe|+field:read|pd|+field:read|au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Layout/Layout/__Renderers",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|"}
,new[] {"/sitecore/system/Settings/Analytics/Page Events",@"ar|sitecore\Analytics Maintaining|pd|+item:delete|+item:create|+item:rename|+item:write|pe|+item:create|"}
...
,new[] {"/sitecore/layout/Layouts/System/Email",@"ar|sitecore\EXM Users|pd|^*|+item:create|+item:read|+item:write|pe|^*|+item:create|+item:read|+item:write|ar|sitecore\EXM Advanced Users|pd|^*|+item:create|+item:read|+item:write|pe|^*|+item:create|+item:read|+item:write|"}
...
,new[] {"/sitecore/Forms",@"ar|sitecore\Forms Editor|pe|+item:read|+item:create|pd|+item:rename|+item:create|+item:delete|+item:read|+item:write|"}
...
,new[] {"/sitecore/templates/System/Templates/Sections/Appearance/Appearance/__Hidden",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Statistics/Statistics/__Updated",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Maintaining|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/system/Marketing Control Panel/Experience Explorer/Presets",@"ar|sitecore\Sitecore Client Designing|pe|+item:create|pd|+item:rename|+item:write|+item:read|+item:delete|+item:create|ar|sitecore\Sitecore Client Authoring|pe|+item:create|pd|+item:rename|+item:write|+item:read|+item:delete|+item:create|"}
,new[] {"/sitecore/system/Marketing Control Panel/Path Analyzer/Maps/Default maps/Site maps/website",@"ar|Everyone|pe|-item:delete|"}
,new[] {"/sitecore/templates/System/Templates/Sections/Appearance/Appearance/__Context Menu",@"au|sitecore\Anonymous|pe|-field:read|pd|-field:read|ar|sitecore\Sitecore Client Configuring|pe|+field:read|pd|+field:read|"}
,new[] {"/sitecore/templates/System/Email/Manager Root/__Standard Values",@"ar|sitecore\EXM Advanced users|pe|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|pd|+item:create|+item:read|+item:rename|+item:delete|+item:write|^*|ar|sitecore\EXM users|pe|+item:read|^*|pd|+item:read|^*|"}
